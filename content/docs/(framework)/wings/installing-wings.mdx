...
Wings is the next generation server control plane from Reviactyl. It is the fork of Pterodactyl wings with additional features.

<Callout type="warning">
You should only install Wings if you are running **Reviactyl v26.x**. <br />
...
curl -L -o /usr/local/bin/wings "https://github.com/reviactyl/wings/releases/latest/download/wings_linux_$([[ "$(uname -m)" == "x86_64" ]] && echo "amd64" || echo "arm64")"
