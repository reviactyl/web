...
<Callout type="error" title="Compatible Versions">
  We've maintained our own blueprint fork to make it compatible with Reviactyl.
  Requires **Reviactyl v2.1.2 and Above**.
</Callout>

## Define Panel directory
Define your panel directory, we'll use this later in the guide. If your Reviactyl webserver is not located in this directory, change the path.
