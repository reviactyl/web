...
* Stop Wings and run `wings --debug` to see if there are any errors being output. If so, try resolving them manually,
  or reach out on [Discord](https://reviactyl.dev/discord) for more assistance.
...
- Check your php version ``php -v`` - [this page](https://reviactyl.dev/docs/panel/updating-the-panel#panel-version-requirements) will tell you what versions of php are supported by what versions of the panel
